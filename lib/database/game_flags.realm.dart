...
class GameFlags extends _GameFlags with RealmEntity, RealmObjectBase, RealmObject {
...
@override
Stream<RealmObjectChanges<GameFlags>> get changes => RealmObjectBase.getChanges<GameFlags>(this);

@override
Stream<RealmObjectChanges<GameFlags>> changesFor([List<String>? keyPaths]) => RealmObjectBase.getChangesFor<GameFlags>(this, keyPaths);
